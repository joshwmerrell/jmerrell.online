...
while OS == 0 :
    ...
    windows = (choice == "1" or choice.lower() == "one" or choice.lower() == "i am using windows." or choice.lower() == "windows") or jmerrells_python_projects.windows
    linux = (choice == "2" or choice.lower() == "two" or choice.lower() == "i am using linux." or choice.lower() == "linux") or jmerrells_python_projects.linux
    macos = (choice == "3" or choice.lower() == "three" or choice.lower() == "i am using macos." or choice.lower() == "macos") or jmerrells_python_projects.macos
    other = (choice == "4" or choice.lower() == "four" or choice.lower() == "i am using something else." or choice.lower() == "other") or jmerrells_python_projects.other
...
# I've added a function to all the prompts that allows the player to quit the game at any time:
...
print("    Pro-tip: you don't have to enter a number into a prompt to proceed.")
print()
print("    Are you ready?\n")
adventure = input("        > ")
...
quit_adventure = adventure.lower() == "quit" or  adventure.lower() == "'quit'"
...
while play == 1 :
    ...
    while decision == 0 :
        ...
        print()
        print("        1  DO NOTHING AND WAIT FOR SOMEONE TO FIND YOU\n        2  TRY TO CALL SOMEONE\n        3  WALK INTO THE WOODS AND FIND A WAY OUT\n")
        choice = input("        > ")

        option_1 = choice == "1" or choice.lower() == "one" or choice.lower() == "i will do nothing and wait for someone to find me." or choice.lower() == "do nothing and wait for someone to find me" or choice.lower() == "do nothing" or choice.lower() == "nothing" or choice.lower() == "wait for someone to find me" or choice.lower() == "wait"
        option_2 = choice == "2" or choice.lower() == "two" or choice.lower() == "i will try to call someone." or choice.lower() == "try to call someone" or choice.lower() == "call someone" or choice.lower() == "call"
        option_3 = choice == "3" or choice.lower() == "three" or choice.lower() == "i will walk into the woods and find a way out." or choice.lower() == "walk into the woods and find a way out" or choice.lower() == "walk into the woods" or choice.lower() == "walk" or choice.lower() == "woods" or choice.lower() == "find a way out"
        quit_game = choice.lower() == "quit" or choice.lower() == "'quit'"
    ...
    while path_1 == 1 :
        ...
        while decision == 0 :
            ...
            option_1 = choice == "1" or choice.lower() == "one" or choice.lower() == "i will follow the animal tracks." or choice.lower() == "follow the animal tracks" or choice.lower() == "follow" or choice.lower() == "animal tracks" or choice.lower() == "animal" or choice.lower() == "tracks"
            option_2 = choice == "2" or choice.lower() == "two" or choice.lower() == "i will make a shelter." or choice.lower() == "make a shelter" or choice.lower() == "shelter"
            quit_game = choice.lower() == "quit" or choice.lower() == "'quit'"
        ...
        while path_1_1 == 1 :
            ...
            print("Following animal tracks is better than doing nothing. You leave the clearing and follow them.")
    ...
    while path_2 == 1 :
        ...
        while decision == 0 :
            ...
            option_1 = choice == "1" or choice.lower() == "one" or choice.lower() == "i will climb a tree to reach service." or choice.lower() == "i will climb a tree." or choice.lower() == "climb a tree to reach service" or choice.lower() == "climb a tree" or choice.lower() == "climb" or choice.lower() == "tree" or choice.lower() == "reach service" or choice.lower() == "service"
            option_2 = choice == "2" or choice.lower() == "two" or choice.lower() == "i will follow the path into the woods." or choice.lower() == "follow the path into the woods" or choice.lower() == "i will follow the path." or choice.lower() == "follow the path" or choice.lower() == "follow" or choice.lower() == "path" or choice.lower() == "woods"
            quit_game = choice.lower() == "quit" or choice.lower() == "'quit'"
        ...
        while path_2_2 == 1 :
            ...
            print("Each sign labels a different trail and doesn't give you any hint if it leads out of the woods or to safety.")
            ...
            print("It is a desecrated campsite with no other person or animal around. There is a notebook inside the ruined tent.")
    ...
    while path_3 == 1 :
        ...
        space()
        print("    You can't just stand around and do nothing. You need to find a way out. With nowhere else to go, you walk into the woods.")
        ...
        while decision == 0 :
            ...
            option_1 = choice == "1" or choice.lower() == "one" or choice.lower() == "i will follow evergreen city trail." or choice.lower() == "follow evergreen city trail" or choice.lower() == "evergreen city trail" or choice.lower() == "evergreen city" or choice.lower() == "evergreen" or choice.lower() == "city"
            option_2 = choice == "2" or choice.lower() == "two" or choice.lower() == "i will follow grizzly camp trail." or choice.lower() == "follow grizzly camp trail" or choice.lower() == "grizzly camp trail" or choice.lower() == "grizzly camp" or choice.lower() == "grizzly" or choice.lower() == "camp"
            option_3 = (choice.lower() == "i will follow sunset mountain trail." or choice.lower() == "follow sunset mountain trail" or choice.lower() == "sunset mountain trail" or choice.lower() == "sunset mountain") and hint == 1
            quit_game = choice.lower() == "quit" or choice.lower() == "'quit'"
        ...
        while path_3_1 == 1 :
            ...
            print("You need to find civilization and be found! Evergreen City sounds like it is exactly the place you need to go.")
            ...
            print("This is a small, abandonded villiage. There is no help to be found here and you still aren't within cell service range.")
        ...
        while path_3_2 == 1 :
            ...
            print("You head up Grizzly Camp Trail. The trail seems to be heading up a hill.")
            ...
            print("Something is hunting you and it feels like its getting closer. You soon reach the camp. It is in a clearing.")
            print("It's full of fallen tents and strewn supplies. There is no one here and whatever did this is now after you!")
        ...
        while path_3_3 == 1 :
            ...
            print("You feel right about it and start up to Sunset Mountain. The day is still young, but you feel as if the night is near.")
            print("As you progress, the trail gets steeper and the shadows beside the trail seem off. They look as if they're reaching for you.")
            ...
            print("It reaches out and grabs at you. Branches break, trees fall and piles of earth slide onto the trail. It is relentless.")
            ...
            print("It is sunset and the darkness is closing in. You're trapped between a void and the sheer overlook drop. Is this it? Is it over?")
            ...
            space()
            end = input("    You Win! Press enter or exit to close out of the game...")
            clear()
    ...
    if lose == 1 :
        ...
        while decision == 0 :
            print()
            print("        You lose. Do you want to try again?\n")
            choice = input("        > ")

            try_again = choice.lower() == "y" or choice.lower() == "yes"
            end_game = choice.lower() == "n" or choice.lower() == "no" or choice.lower() == "quit" or choice.lower() == "'quit'"
